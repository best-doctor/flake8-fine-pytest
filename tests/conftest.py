...
def parse_options(allowed_test_directories, allowed_test_arguments_count):
...
def run_validator_for_test_files():
    def _run(filename, allowed_test_directories=None, allowed_test_arguments_count=None):
        ...
        parse_options(allowed_test_directories, allowed_test_arguments_count)
